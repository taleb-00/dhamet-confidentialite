...
Dhamet se joue sans compte et sans rien donner de vous. Si vous jouez en ligne ou vous connectez avec Google, l’app garde le strict nécessaire pour faire fonctionner ces services : un nom, un portrait, un classement, vos parties et vos amis. Pas de publicité, pas de pistage, rien n’est vendu. Vous pouvez tout supprimer depuis l’app, à tout moment.
...
Vous pouvez modifier votre nom et votre portrait, effacer votre carnet, et supprimer votre compte depuis l’app (Profil ou Réglages → Supprimer mon compte) : votre fiche, votre carnet, vos amitiés, votre code ami et votre compte sont effacés, ainsi que les données de ce téléphone. Sans compte, « Effacer mes données » fait de même pour le téléphone. Pour toute demande d’accès, de rectification ou d’effacement, écrivez-nous.

### Enfants

Le jeu hors ligne ne demande aucune donnée personnelle et convient à tous. Les comptes Google et le jeu en ligne sont réservés à l’âge minimum fixé par Google dans votre pays.

### Contact

Taleb Mohamed Maouloud — I2d.contact@yahoo.com. Si cette politique change, la nouvelle version sera dans l’app, avec sa date.

## English

### In short

Dhamet can be played without an account and without giving anything about yourself. If you play online or sign in with Google, the app keeps only what these services need to work: a name, a portrait, a rating, your games and your friends. No ads, no tracking, nothing is sold. You can delete everything from the app, at any time.
...
You can change your name and portrait, clear your record, and delete your account from the app (Profile or Settings → Delete my account): your profile, record, friendships, friend code and account are erased, along with the data on this phone. Without an account, “Erase my data” does the same for the phone. For any request to access, correct or erase your data, write to us.

### Children

Offline play asks for no personal data and suits everyone. Google accounts and online play are for the minimum age set by Google in your country.

### Contact

Taleb Mohamed Maouloud — I2d.contact@yahoo.com. If this policy changes, the new version will be in the app, with its date.
...
يمكن لعب ظامت دون حساب ودون تقديم أي معلومة عنك. إذا لعبت عبر الإنترنت أو سجّلت الدخول بحساب Google، يحتفظ التطبيق بالحد الأدنى اللازم لعمل هذه الخدمات: اسم وصورة وتصنيف ومبارياتك وأصدقاؤك. لا إعلانات، لا تتبّع، ولا يُباع أي شيء. يمكنك حذف كل شيء من التطبيق في أي وقت.
...
يمكنك تغيير اسمك وصورتك، ومسح سجلك، وحذف حسابك من التطبيق (الملف أو الإعدادات ← حذف حسابي): تُمحى بطاقتك وسجلك وصداقاتك ورمز صداقتك وحسابك، مع بيانات هذا الهاتف. دون حساب، يفعل «مسح بياناتي» الشيء نفسه للهاتف. لأي طلب اطلاع أو تصحيح أو حذف، راسلنا.

### الأطفال

اللعب دون اتصال لا يطلب أي بيانات شخصية ويناسب الجميع. أما حسابات Google واللعب عبر الإنترنت فمخصّصة للسن الأدنى الذي تحدّده Google في بلدك.

### التواصل

طالب محمد مولود — I2d.contact@yahoo.com. إذا تغيّرت هذه السياسة، ستكون النسخة الجديدة في التطبيق مع تاريخها.
